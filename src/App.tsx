  ...
  SwalReact.fire({
    ...
    html: (
      <>
        <h2>關於</h2>
        <p>
          切韻音系自動推導器（下稱「本頁面」）由 <a href="https://nk2028.shn.hk/">Ngiox Khyen 2028 項目</a>
          開發。我們開發有關語言學的項目，尤其是有關歷史漢語語音學，異體字和日語語言學的項目。
        </p>
        <p>
          歡迎加入 QQ 音韻學答疑羣（羣號 526333751）和 Telegram 更新頻道（<a href="https://t.me/nk2028">@nk2028</a>）。
        </p>
        <p>
        ...
        <b>閣下鍵入的內容</b>
        <p>
          本頁面的開發者不會收集閣下在本頁面中鍵入的任何內容。任何與閣下鍵入的內容相關的運算全部在閣下的系統中完成。本頁面不會將包括待標註的文本、標註結果在內的任何資料傳送至任何伺服器。
        </p>
        <b>閣下的其他資料</b>
        <p>
