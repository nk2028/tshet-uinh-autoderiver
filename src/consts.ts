...
export const defaultArticle =
  ...
  "四美具，二難(泥開一寒平)并(幫三A清去)。窮睇(定開四齊去)眄(明四先上)於(影開三C魚平)中(知三東平)天，極娛(疑合三C虞平)遊於(影開三C魚平)暇日。" +
  "天高地迥，覺(見二江入)宇宙之無窮；興(曉開三C蒸去)盡(從開三真上)悲來，識(書開三蒸入)盈虛(曉開三C魚平)之有數(生合三虞去)。" +
  "望(明三C陽平)長(澄開三陽平)安於(影開三C魚平)日下(匣開二麻上)，目吳會(匣合一泰去)於(影開三C魚平)雲間(見開二山平)。" +
  "地勢極而南溟(明四青平)深(書開三侵平)，天柱(澄合三虞上)高而北辰遠(云合三C元上)。關山難(泥開一寒平)越(云合三C元入)，誰悲失路之人。" +
  "萍水相(心開三陽平)逢，盡(從開三真上)是他鄉之客。懷帝閽而不(幫三C文入)見(見開四先去)，奉宣室以何(匣開一歌平)年？";
